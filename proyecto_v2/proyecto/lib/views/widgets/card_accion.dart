...
class _CardAccionState extends State<CardAccion> {
 ...
 'Las personas no nacen igual. El protagonista de esta historia es uno de esos casos raros que nacen sin superpoderes, pero esto no le impedirá perseguir su sueño: ser un gran héroe como el legendario All-Might. Para convertirse en el héroe que quiere ser, se apuntará a una de las academias de héroes más prestigiosas del país: Yueiko. Con la ayuda de su ídolo, All-Might, ¿podrá convertirse en un verdadero héroe?',
  '8.18','24m','https://www.youtube.com/watch?v=lFXpmYK6SEQ'];
  ...
  '7.78','23m','https://www.youtube.com/watch?v=f9OV_KzR3SM'];
  ...
  '8.57','23m','https://www.youtube.com/watch?v=VQGCKyvzIM4'];
  ...
  '9.08','24m','https://www.youtube.com/watch?v=44qfOGvEWAU'];
        ...
        child: InkWell(
         onTap:(){
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=>    PaginaIndividual(nombre: animeA1[0], imagen: animeA1[1], descripcion: animeA1[2], score: animeA1[3], tiempo: animeA1[4], url: animeA1[5])
                  )
                );
              },
      ...
      child:  Stack(
       ...
       Card(
        child: InkWell(
         onTap:(){
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=>   PaginaIndividual(nombre: animeA2[0], imagen: animeA2[1], descripcion: animeA2[2], score: animeA2[3], tiempo: animeA2[4], url: animeA2[5])
                  )
                );
              },
               child: Column(children: [
      ...
      child:  Stack(
       ...
       Card(
        child: InkWell(
         onTap:(){
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=>   PaginaIndividual(nombre: animeA3[0], imagen: animeA3[1], descripcion: animeA3[2], score: animeA3[3], tiempo:animeA3[4], url: animeA3[5])
                  )
                );
              },
               child: Column(children: [
      ...
      child:  Stack(
       ...
       Card(
        child: InkWell(
         onTap:(){
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=>   PaginaIndividual(nombre: animeA4[0], imagen: animeA4[1], descripcion: animeA4[2], score: animeA4[3], tiempo: animeA4[4], url: animeA4[5])
                  )
                );
              },
               child: Column(children: [
